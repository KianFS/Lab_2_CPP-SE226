...
int main() {
    ...
    string words[1000] = {"a", "ability", "able", "about", "above", "accept", "according", "account", "across",
                          "act",
    ...
    cout << "******************************************Question3************************************" << endl;
    int maxAst;
    cout << " Enter number between 3 and 9(inclusive):" << endl;
    cin >> maxAst;
    char star = '*';
    if (3 <= maxAst && maxAst <= 9) {
        for (int i = 1; i < maxAst + 1; ++i) {
            cout << string(i, star) << endl; // I used it to do like : '*' * i
        }
        for (int i = maxAst - 1; i > 0; i--) {
            cout << string(i, star) << endl;
        }
    } else { cout << "number is not between 3 and 9" << endl; }
